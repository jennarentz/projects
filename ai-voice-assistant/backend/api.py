...
#see functions in terminal to see if working
logger.setLevel(logging.INFO)

DB = DatabaseDriver()

#annotate what should be passed to the functions
#need the typing in python so model knows what values to pass to functions for parameters
#model then can use for tools
...
class AssistantFnc(llm.FunctionContext):
    def __init__(self):
        ...
        self._car_details = {
            #know name of field when accessing values in class
            CarDetails.VIN: "",
            CarDetails.Make: "",
            CarDetails.Model: "",
            CarDetails.Year: ""
    ...
    #read by callable to see if it should use this function
    #annotated gives extra info to model
